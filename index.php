                    ...
                    <?php foreach ($groupedTransactions as $client => $months): ?>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-gray-100 dark:border-gray-700 transition-all duration-200 hover:shadow-md">
                            ...
                            <div class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                ?>
                                    <div class="month-section flex flex-col">
    ...
    <script>
        ...
        function shareViaWhatsApp(event, client, month, balance, transactions) {
            ...
            let transactionList = transactions.map(t => {
                const amount = 'Rp ' + numberWithCommas(parseFloat(t.amount).toFixed(0));
            ...
            const message = `💼 *${client} - ${displayMonth}*\n\n` +
                           `📈 *Pemasukan:* Rp +${numberWithCommas(totalIncome.toFixed(0))}\n` +
                           `📉 *Pengeluaran:* Rp -${numberWithCommas(totalExpense.toFixed(0))}\n` +
                           `💰 *Saldo:* Rp ${balance >= 0 ? '+' : ''}${numberWithCommas(balance.toFixed(0))}\n\n` +
                           `*Detail:*\n${transactionList}`;
